...
extern int dword_800ABBC8;
int dword_800ABBC8;

extern int dword_8009EEF0;
int dword_8009EEF0;

extern int dword_8009EEF4;
int dword_8009EEF4;

extern SVECTOR *dword_800ABBB8;
SVECTOR *dword_800ABBB8;

extern SVECTOR *dword_800ABBCC;
SVECTOR *dword_800ABBCC;

extern int dword_800ABBA4_move_angle;
int dword_800ABBA4_move_angle;

extern int dword_800ABBAC;
int dword_800ABBAC;
...
extern int                dword_8009EED4[];
extern int                dword_8009EED8[];
extern int                dword_8009EEE0[];
extern int                dword_8009EEE4[];
...
inline static int sna_init_main_logic_helper_helper_800596FC(Actor_SnaInit *pActor)
{
  SVECTOR *local_40[2];
  RECT rect[2];
  CONTROL *pCtrl;
...
static inline void sna_init_main_logic_helper_800596FC(Actor_SnaInit *pActor)
{
    ...
    dword_800ABBA4_move_angle = pActor->field_9B0_pad_ptr->dir;
    dword_800ABBC8 = dword_800ABBCC;
    dword_800ABBAC = 0;
    dword_800ABBC4 = 0;
    dword_800ABBB0 = 0;
    dword_800ABBCC = 0;
    ...
    dir = dword_800ABBA4_move_angle;

    pActor->field_79C = 0;
    cVar4 = pActor->field_20_ctrl.field_58;

    if ((cVar4 <= 0) || sna_init_sub_8004E358(pActor, SNA_FLAG2_UNK5))
    {
        return;
    }
    ...
    if (result != 2)
    {
        dword_800ABBCC = &pActor->field_20_ctrl.field_60_vecs_ary[result];
        dword_800ABBD0 = GV_VecDir2_80016EF8(dword_800ABBCC);
...
static inline void sna_init_main_logic_helper2_800596FC(Actor_SnaInit *pActor)
{
    ...
    else if (!dword_800ABBB8 || (dword_800ABBB8->pad == 2))
    {
        pActor->field_A2A = 0;
...
static inline void sna_init_main_logic_helper3_800596FC(Actor_SnaInit *pActor)
{
    ...
    if (pActor->field_9E4.field_9F0 != 0)
    {
        ...
        if ((uVar13 & 0x800) != 0)
        {
            sna_init_8004E22C(pActor, sna_init_8004EAA8(pActor, pActor->field_A26_stance), 0);
        }
...
static inline void sna_init_main_logic_helper4_800596FC(Actor_SnaInit *pActor)
{
    ...
    else
    {
        ...
        if (pTarget->field_6_flags & 0x6)
        {
            ...
            {
                pActor->field_20_ctrl.field_55_skip_flag &= ~0x2;
                ...
                if (!bVar6)
                {
                    ...
                    {
                        sna_init_set_flags1_8004E2F4(pActor, 0x4);
                        sna_init_start_anim_8004E1F4(pActor, &sna_anim_knockdown_shot_80054B50);
                    }
                    else if (GM_CheckPlayerStatusFlag_8004E29C(PLAYER_UNK1000))
                    {
                        sna_init_set_flags1_8004E2F4(pActor, 0x20);
                        sna_init_start_anim_8004E1F4(pActor, &sna_act_helper2_helper7_80054648);
                    }
                    else
                    {
                        sna_init_start_anim_8004E1F4(pActor, &sna_anim_shot_flinch_800544E0);
                    }

                    GM_SeSet2_80032968(0, 63, 24); // Snake pain 1

                    vibrate_init2_8005D58C(dword_8009EED4, 1);
                    vibrate_init2_8005D58C(dword_8009EED8, 2);
                }
                else
                {
                    ...
                    if (GM_CheckPlayerStatusFlag_8004E29C(PLAYER_PRONE | PLAYER_UNK200))
                    {
                        if (!GM_CheckPlayerStatusFlag_8004E29C(PLAYER_UNK200))
                        {
                            pActor->field_A54.choke_count = 1; // choke_count was guessed
                        }

                        sna_init_start_anim_8004E1F4(pActor, &sna_anim_knockdown_shot_tank_80054C08);
                    }
                    else
                    {
                        sna_init_start_anim_8004E1F4(pActor, &sna_anim_knockdown_80054710);
                    }
                    ...
                    vibrate_init2_8005D58C(dword_8009EEE0, 1);
                    vibrate_init2_8005D58C(dword_8009EEE4, 2);

                    sna_init_8004EC00(pActor);
                    sna_init_set_flags1_8004E2F4(pActor, 4);
                }

                sna_init_act_helper2_helper4_8004F090(pActor, iVar8);
            }
            else
            {
                sna_init_set_invuln_8004F2A0(pActor, 0x20);

                if (pTarget->field_28 > 0)
                {
                    sna_init_act_helper2_helper4_8004F090(pActor, pTarget->field_3E);
                }
                ...
                if ((pTarget->field_26_hp < 1) && ((GM_GameOverTimer_800AB3D4 > -2) && (GM_GameOverTimer_800AB3D4 < 1)))
                {
                    ...
                    if (GM_CheckPlayerStatusFlag_8004E29C(PLAYER_UNK200))
                    {
                        if (pActor->field_A54.choke_count == 1) // choke_count was guessed
                        {
                            iVar9 = 0x7e;
                        }
                        else
                    ...
                    sna_init_8004F8E4(pActor, iVar9);
                }
            }
...
static inline void sna_init_main_logic_helper5_800596FC(Actor_SnaInit *pActor)
{
    if (GM_CheckPlayerStatusFlag_8004E29C(PLAYER_GAMEOVER))
    {
        ...
        {
            vibrate_init2_8005D58C(&dword_8009EEF0, 1);
            vibrate_init2_8005D58C(&dword_8009EEF4, 2);
            ...
            (GM_StreamStatus_80037CD8() != 2))
        {
            ...
            sna_init_set_flags1_8004E2F4(pActor, 0x40000);
            GM_GameOverTimer_800AB3D4 = 1;
        }
    }
    else if (GM_GameOverTimer_800AB3D4 > 0)
    {
        ...
        if (GM_GameOverTimer_800AB3D4 == 2)
        {
            sna_init_set_flags1_8004E2F4(pActor, 0x80000);
...
static inline int sna_init_main_logic_helper6_helper2_800596FC(Actor_SnaInit *pActor)
{
    if ((pActor->field_920_tbl_8009D580 & 0x200) ||
        ...
        sna_init_sub_8004E358(pActor, 0x100))
    {
        return 0;
    }
...
static inline void sna_init_main_logic_helper6_800596FC(Actor_SnaInit *pActor)
{
    ...
    {
        if (!sna_init_sub_8004E358(pActor, 0x10) && sna_init_main_logic_helper6_helper2_800596FC(pActor))
        {
            if (pActor->field_9B0_pad_ptr->quick & PAD_TRIANGLE)
            {
                sub_8004EB74(pActor);
                sna_init_set_flags2_8004E330(pActor, 0x10);
            }
        ...
        {
            sna_init_set_flags2_8004E330(pActor, 0x20);
...
void sna_init_main_logic_800596FC(Actor_SnaInit *pActor)
{
    ...
    if ( pPad->analog != 0 && (pPad->status & (PAD_LEFT | PAD_DOWN | PAD_RIGHT | PAD_UP)) )
    {
        ...
        for ( i = 0; i < 2; i++, pAxis++ )
        {
            ...
            {
                sna_init_set_flags1_8004E2F4(pActor, SNA_FLAG1_UNK15);
                break;
            }
        }
    }
    ...
    if ( GM_SnakeState & 1 )
    {
        ...
        if ( sna_init_act_helper2_helper5_8004FF88(pActor) && (pActor->field_A5C == 900) )
        {
            pActor->field_A5C = 0;
            sna_init_start_anim_8004E1F4(pActor, &sna_act_helper2_helper_80054EFC);
        }
    }

    sna_init_weapon_switching_800511BC(pActor, 1);
    sna_init_800515BC(pActor, 1);
    ...
    sna_init_act_helper2_helper3_8004ED6C(pActor);
    ...
    if ( GM_UnkFlagBE != 0 )
    {
        var_v0_8 = sna_init_sub_8004E358(pActor, SNA_FLAG2_UNK6);
    }
    else
    {
    ...
    if ( GM_StreamStatus_80037CD8() == 2 )
    {
        ...
        sna_init_act_helper2_helper2_80033054(0x21CA, &pActor->field_718[6]);
